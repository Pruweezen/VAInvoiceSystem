...
CREATE TABLE `invoice_services` (
  ...
  KEY `invoice_services_ibfk_1` (`invoice_id`),
  CONSTRAINT `invoice_services_ibfk_1` FOREIGN KEY (`invoice_id`) REFERENCES `invoices` (`invoice_id`) ON DELETE CASCADE,
  CONSTRAINT `invoice_services_ibfk_2` FOREIGN KEY (`service_id`) REFERENCES `service_management` (`service_id`)
...
INSERT INTO `invoice_services` VALUES (3,5,2001,5.00),(4,6,2001,2.00),(5,7,2001,3.00),(7,7,2005,3.00),(8,10,2002,1.00);
